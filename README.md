...
## Who uses redux-bees
If your company or project uses Recompose, feel free to add it to [the official list of users](https://github.com/cantierecreativo/redux-bees/wiki/Sites-Using-Recompose) by [editing](https://github.com/cantierecreativo/redux-bees/wiki/Sites-Using-Recompose/_edit) the wiki page.
